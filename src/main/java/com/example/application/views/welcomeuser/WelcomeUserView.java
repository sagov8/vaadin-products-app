package com.example.application.views.welcomeuser;
...
@Route(value = "welcome-user", layout = MainLayout.class)
@RolesAllowed("USER")
public class WelcomeUserView extends Div implements AfterNavigationObserver {

    Grid<Person> grid = new Grid<>();

    public WelcomeUserView() {
        addClassName("welcome-user-view");
        setSizeFull();
        grid.setHeight("100%");
